...
contract AVAXGods is ERC1155, Ownable, ERC1155Supply {
  ...
  mapping(address => uint256) public playerTokenInfo; // player addresses => player token index in the gameTokens array
  mapping(string => uint256) public battleInfo; // battle name => battle index in the battles array
